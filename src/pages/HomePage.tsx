...
const HomePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="bg-white border-b border-gray-200 py-3 sm:py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <span className="text-xs sm:text-sm text-gray-600 hidden sm:inline">How it works</span>
              <span className="text-xs sm:text-sm text-gray-600">Log in</span>
              {/* Mobile menu button */}
      ...
      {/* Hero Section */}
      <section className="relative h-[500px] sm:h-[623px] md:h-[720px] bg-gradient-to-br from-gray-900 to-gray-800">
        <div className="absolute inset-0 bg-black bg-opacity-20"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-2xl text-center sm:text-left">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-2 sm:mb-4">
              Live large.
            </h1>
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-white/70 mb-4 sm:mb-6">
              Spend small.
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6 sm:mb-8 max-w-lg mx-auto sm:mx-0">
            ...
            <button className="bg-white text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg hover:bg-gray-100 transition-colors w-full sm:w-auto">
              View cars
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="aspect-video bg-gray-200 rounded-xl sm:rounded-2xl flex items-center justify-center">
            <div className="text-center">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gray-300 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <svg
              ...
              <p className="text-sm sm:text-base text-gray-600">Video: Flexcar in 75 seconds</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <button className="bg-gray-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-gray-800 transition-colors w-full sm:w-auto">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-white border border-gray-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 hover:border-purple-500 transition-colors cursor-pointer">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">SUVs</h3>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 hover:border-purple-500 transition-colors cursor-pointer">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Sedans</h3>
              <div className="h-6 sm:h-8"></div>
              <img
            ...
            <div className="bg-white border border-gray-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 hover:border-purple-500 transition-colors cursor-pointer">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Trucks</h3>
              <div className="h-6 sm:h-8"></div>
              <img
            ...
            <div className="bg-white border border-gray-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 hover:border-purple-500 transition-colors cursor-pointer">
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Minivans</h3>
              <div className="h-6 sm:h-8"></div>
              <img
          ...
          <div className="text-center mt-8 sm:mt-12">
            <button className="bg-gradient-to-r from-teal-400 to-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:shadow-lg transition-all w-full sm:w-auto">
              View all cars
            </button>
          </div>
        </div>
            ...
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-6 sm:space-y-8">
                <div>
                  ...
                  <div className="w-12 sm:w-14 h-1 bg-gray-900 mb-3 sm:mb-4"></div>
              ...
              <button className="mt-6 sm:mt-8 bg-gray-900 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-gray-800 transition-colors w-full sm:w-auto">
                View cars
              </button>
            </div>
            <div className="order-1 md:order-2">
      ...
      {/* Reviews Section */}
      <section className="py-12 sm:py-16 md:py-20 bg-gray-900 text-white relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button className="bg-white text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-gray-100 transition-colors w-full sm:w-auto">
            See our reviews
          </button>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <div className="sm:col-span-2 md:col-span-1">
              <div className="flex items-center space-x-2 mb-3 sm:mb-4">
                ...
                <span className="text-lg sm:text-2xl font-bold text-white">FLEXCAR</span>
              </div>
              <p className="text-sm sm:text-base text-gray-400">Live large. Spend small.</p>
            </div>

            <div>
              <h4 className="font-bold mb-3 sm:mb-4 text-sm sm:text-base">Flexcar</h4>
